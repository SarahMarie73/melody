			...
			<div id="the-list">
				...
				<?php
					foreach ( ( array ) $item as $plugin ) {
						...
						if ($plugin["slug"] != 'wpcalc' && $plugin["slug"] != 'marketing-wp' && $plugin["slug"] != 'wpcalc-ceiling' && $plugin["slug"] != 'wpcalc-cookie-timer' && $plugin["slug"] != 'wpcalc-delivery' && $plugin["slug"] != 'wpcalc-loan' && $plugin["slug"] != 'wpcalc-modal-form' && $plugin["slug"] != 'wpcalc-osago-rus' && $plugin["slug"] != 'wpcalc-osago-ukr' && $plugin["slug"] != 'mwp-side-menu' && $plugin["slug"] != 'mwp-modal-windows' && $plugin["slug"] != 'viral-signup'){
